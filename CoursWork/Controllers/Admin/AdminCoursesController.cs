...
namespace CoursWork.Controllers.Admin
{
    public class AdminCoursesController : Controller
    {
        ...
        public AdminCoursesController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Dicription,PhotoUrl,Date")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Dicription,PhotoUrl,Date")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
